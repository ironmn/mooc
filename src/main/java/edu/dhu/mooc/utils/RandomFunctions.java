 ...
 * @date: 2021-03-14
 * @Describe: 中文姓名随机生成器
 * @Main Function : String getChinese();
 */
public class RandomFunctions {

    public static void main(String[] args) {
//        for(int i =0 ;i<1000;i++){
//            System.out.println(getRandomChineseName()+"\t"+getRandPhoneNumber());
//        }
        for(int i = 0;i<100;i++){
            System.out.println(getRandomStuNum()+"\t"+getRandomGender());
        }
    }
    //中国移动
...
//    getChineseGivenName方法具体实现如下
    ...
    public static String getRandomStuNum(){
        String ans = "";
        Random random = new Random();
        ans += String.format("%02d",random.nextInt(22));
        ans += String.format("%05d",random.nextInt(99999));
        return ans;
    }
}
